...
class CPG:
  def __init__(self, speed, EES_int, inh_p, step_number, N = 20):
    ...
    CV1 = self.addafferents(self.ncell*2, "CV1")
    CV2 = self.addafferents(self.ncell*2, "CV2")
    CV3 = self.addafferents(self.ncell*2, "CV3")
    CV4 = self.addafferents(self.ncell*2, "CV4")
    CV5 = self.addafferents(self.ncell*2, "CV5")
    ...
    iIP_E = self.addpool(self.ncell, False, "iIP_E")
    iIP_F = self.addpool(self.ncell, False, "iIP_F")
    ...
    #connect C-geners with CV fibers
    exconnectcells(C1, CV1[:int(len(CV1)/2)], 0.8, 1, 50)
    exconnectcells(C2, CV2[:int(len(CV2)/2)], 0.8, 1, 50)
    exconnectcells(C3, CV3[:int(len(CV3)/2)], 0.8, 1, 50)
    exconnectcells(C4, CV4[:int(len(CV4)/2)], 0.8, 1, 50)
    exconnectcells(C5, CV5[:int(len(CV5)/2)], 0.8, 1, 50)

    #inhibitory projections
    #extensor
    exconnectcells(CV3, OM1_3, 0.8, 1, 50)

    exconnectcells(CV4, OM1_3, 0.8, 1, 50)
    exconnectcells(CV4, OM2_3, 0.8, 1, 50)

    exconnectcells(CV5, OM1_3, 0.8, 1, 50)
    exconnectcells(CV5, OM2_3, 0.8, 1, 50)
    exconnectcells(CV5, OM3_3, 0.8, 1, 50)
    exconnectcells(CV5, OM4_3, 0.8, 1, 50)
    
    #EES
    genconnect(ees, CV1, 1, 0, 50)
    ...
    exconnectcells(IP1_E, iIP_E, 0.8, 1, 80)
    exconnectcells(IP2_E, iIP_E, 0.8, 1, 80)
    exconnectcells(IP3_E, iIP_E, 0.8, 1, 80)
    exconnectcells(IP4_E, iIP_E, 0.8, 1, 60)
    exconnectcells(IP5_E, iIP_E, 0.8, 1, 60)
    ...
    inhconnectcells(IP4_E, Ia_aff_E, 0.03, 2, 40)
    inhconnectcells(IP5_E, Ia_aff_E, 0.03, 2, 40)
    ...
    exconnectcells(IP1_F, iIP_F, 0.8, 1, 80)
    exconnectcells(IP2_F, iIP_F, 0.8, 1, 80)
    exconnectcells(IP3_F, iIP_F, 0.8, 1, 80)
    exconnectcells(IP4_F, iIP_F, 0.8, 1, 60)
    exconnectcells(IP5_F, iIP_F, 0.8, 1, 60)
    ...
    inhconnectcells(IP1_E, Ia_aff_E, 0.001, 2, 40)
    inhconnectcells(IP2_E, Ia_aff_E, 0.0001, 2, 40)
    inhconnectcells(IP3_E, Ia_aff_E, 0.001, 2, 30)
    inhconnectcells(IP4_E, Ia_aff_E, 0.001, 2, 40)
    inhconnectcells(IP5_E, Ia_aff_E, 0.001, 2, 40)

    #skin inputs
    #C1
    exconnectcells(CV1[:int(len(CV1)/2)], OM1_0E, 0.0005, 1, 50)

    #C2
    exconnectcells(CV2[:int(len(CV2)/2)], OM1_0E, 0.0005, 1, 27)
    exconnectcells(CV2[:int(len(CV2)/2)], OM2_0E, 0.00045, 1, 27)

    #C3
    exconnectcells(CV3[:int(len(CV3)/2)], OM2_0E, 0.00045, 1, 27)
    exconnectcells(CV3[:int(len(CV3)/2)], OM3_0 , 0.00035, 1, 27)

    #C4
    exconnectcells(CV4[:int(len(CV4)/2)], OM3_0 , 0.00038, 1, 27)
    exconnectcells(CV4[:int(len(CV4)/2)], OM4_0E, 0.0004, 1, 27)

    #C5
    exconnectcells(CV5[:int(len(CV5)/2)], OM5_0 , 0.0003, 1, 30)
    exconnectcells(CV5[:int(len(CV5)/2)], OM4_0E, 0.00025, 1, 30)
    
    #C=1 Extensor
    inhconnectcells(iIP_E, OM1_0F, 0.8, 1, 50)
    inhconnectcells(iIP_E, OM2_0F, 0.8, 1, 50)
    inhconnectcells(iIP_E, OM4_0F, 0.8, 1, 50)
    inhconnectcells(iIP_E, OM3_2F, 0.8, 1, 50)

    inhconnectcells(iIP_E, IP1_F, 0.8, 1, 60)
    inhconnectcells(iIP_E, IP2_F, 0.8, 1, 60)
    inhconnectcells(iIP_E, IP3_F, 0.8, 1, 60)
    inhconnectcells(iIP_E, IP4_F, 0.8, 1, 60)
    inhconnectcells(iIP_E, IP5_F, 0.8, 1, 60)

    inhconnectcells(iIP_E, Ia_aff_F, 0.9, 1, 80)

    #C=0 Flexor
    inhconnectcells(iIP_F, IP1_E, 0.8, 1, 60)
    inhconnectcells(iIP_F, IP2_E, 0.8, 1, 60)
    inhconnectcells(iIP_F, IP3_E, 0.8, 1, 60)
    inhconnectcells(iIP_F, IP4_E, 0.8, 1, 60)
    inhconnectcells(iIP_F, IP5_E, 0.8, 1, 60)

    inhconnectcells(iIP_F, Ia_aff_E, 0.8, 1, 80)

    #reflex arc
    exconnectcells(Iagener_E, Ia_aff_E[:int(len(Ia_aff_E)/5)], 0.8, 1, 20)
    exconnectcells(Ia_aff_E, Ia_E, 0.5, 1, 30)
    exconnectcells(Ia_aff_E[:int(len(Ia_aff_E)/3)], Ia_E, 0.8, 1, 30)
    exconnectcells(Ia_E, iIP_E, 0.8, 1, 50)
    exconnectcells(mns_E, R_E, 0.00025, 1, 30)
    inhconnectcells(Ia_E, mns_F, 0.5, 1, 50)
    inhconnectcells(R_E, mns_E, 0.05, 1, 45)
    inhconnectcells(R_E, Ia_E, 0.01, 1, 40)

    exconnectcells(Iagener_F, Ia_aff_F[:int(len(Ia_aff_F)/5)], 0.08, 1, 20)
    exconnectcells(Ia_aff_F, Ia_F, 0.5, 1, 30)
    exconnectcells(Ia_aff_F[:int(len(Ia_aff_F)/3)], Ia_F, 0.8, 1, 30)
    exconnectcells(Ia_F, iIP_F, 0.8, 1, 50)    
...
def createmotif(om0, om1, om2, om3):
  ...
  '''
  exconnectcells(om0, om1, 0.05, 2, 27)
