...
class CPG:
    def __init__(self, speed, ees_fr, inh_p, step_number, layers, extra_layers, N):
        ...
        for layer in range(2, layers+1):
            if layer > 3:
                for i in range(0, (layer - 2)):
                    connectcells(self.dict_C[layer], self.dict_3[i], 0.65, 1)
            else:
        ...
        connectcells(self.mns_E, self.muscle_E, 0.55, 1, False, 65)
        connectcells(self.mns_E, self.muscle_F, 0.55, 1, False, 65)
