...
class CPG:
    def __init__(self, speed, ees_fr, inh_p, step_number, layers, extra_layers, N):
        ...
        '''extensor'''
        for layer in range(1, layers):
            connectcells(self.dict_CV[layer - 1], self.dict_CV[layer], 0.95, 2)
        ...
        for layer in range(layers):
            ...
            connectcells(self.dict_2E[layer], self.dict_IP_E[layer], 1.25, 1)
            connectcells(self.dict_IP_E[layer], self.mns_E, 1.75, 1)
            if layer > 3:
            ...
            connectcells(self.dict_2F[layer], self.dict_IP_F[layer], 1.25, 1)
        ...
        #
        '''C4'''
        connectcells(self.dict_CV_1[3], self.dict_0[2], 0.00042*k*speed, 3)
        connectcells(self.dict_CV_1[3], self.dict_0[3], 0.00035*k*speed, 3)
        connectcells(self.dict_CV_1[4], self.dict_0[2], 0.00042*k*speed, 3)
