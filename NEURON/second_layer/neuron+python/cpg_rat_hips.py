    ...
    def __init__(self, speed, ees_fr, inh_p, step_number, layers, extra_layers, N):
        ...
        for layer in range(layers+1):
            ...
            for i in range(step_number):
                self.dict_C[layer].append(self.addgener(150 + speed * layer + i * (speed * (layers + 1) + 125), random.gauss(cfr, cfr/10), (speed / c_int + 1)))
        ...
        for i in range(step_number):
            self.C_0.append(self.addgener(25 + speed * 4 + i * (speed * 6 + 125), cfr, 125/c_int, False))
            self.V0v.append(self.addgener(25 + speed * 4 + i * (speed * 6 + 125), 100, int(125/10), False))
