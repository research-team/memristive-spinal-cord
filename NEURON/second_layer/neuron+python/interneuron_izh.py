...
class interneuron_izh(object):
  ...
  def biophys(self):
    ...
    '''
    diff = h.Izhi2003b(self.soma(0.5))
    # diff.C = 0.5 # Capacitance
    # diff.k = 0.7
    # diff.vr = -70 # Resting membrane potential
    # diff.vt = -40 # Membrane threhsold
    # diff.vpeak = 35 # Peak voltage
    # diff.a = 0.03
    # diff.b = -2
    # diff.c = -50
    # diff.d = 100
