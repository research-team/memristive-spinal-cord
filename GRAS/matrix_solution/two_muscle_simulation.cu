...
void simulate(int test_index, int full_save) {
	...
	int begin_C_spiking[5] = {ms_to_step(0), ms_to_step(25), ms_to_step(50), ms_to_step(75), ms_to_step(125)};
	int end_C_spiking[5] = {ms_to_step(25), ms_to_step(50), ms_to_step(75), ms_to_step(125), ms_to_step(150)};
