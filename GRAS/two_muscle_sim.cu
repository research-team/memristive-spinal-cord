...
void init_network(float inh_coef, int pedal, int has5ht) {
	...
	connect_fixed_outdegree(E1, OM1_0, 2, 0.1);
	// input from sensory
	connect_one_to_all(CV1, OM1_0, 0.5, 0.2 * quadru_coef * sero_coef);
	connect_one_to_all(CV2, OM1_0, 0.5, 0.2 * quadru_coef * sero_coef);
	// [inhibition]
	connect_one_to_all(CV3, OM1_3, 1, 0.2);
	connect_one_to_all(CV4, OM1_3, 1, 0.2);
	connect_one_to_all(CV5, OM1_3, 1, 0.2);
	// inner connectomes
	connect_fixed_outdegree(OM1_0, OM1_1, 1, 0.1);
	connect_fixed_outdegree(OM1_1, OM1_2_E, 1, 0.1);
	connect_fixed_outdegree(OM1_1, OM1_2_F, 1, 0.1);
	connect_fixed_outdegree(OM1_1, OM1_3, 1, 0.1);
	connect_fixed_outdegree(OM1_2_E, OM1_1, 2.5, 0.1);
	connect_fixed_outdegree(OM1_2_F, OM1_1, 2.5, 0.1);
	connect_fixed_outdegree(OM1_2_E, OM1_3, 1, 0.1);
	connect_fixed_outdegree(OM1_2_F, OM1_3, 1, 0.1);
	connect_fixed_outdegree(OM1_3, OM1_1, 1, -0.1 * inh_coef);
