...
def create_network(inh_coef):
    ...
    connect_fixed_outdegree(all_neurons['OM2_0'], all_neurons['OM2_1'], 1, 30)
    ...
    connect_fixed_outdegree(all_neurons['OM2_2_E'], all_neurons['OM2_1'], 2.5, 18.05)
    ...
    connect_fixed_outdegree(all_neurons['OM3_1'], all_neurons['OM3_2_E'], 1, 21)
    ...
    connect_fixed_outdegree(all_neurons['OM3_3'], all_neurons['OM3_2_E'], 0.3, -23)
    ...
    connect_fixed_outdegree(all_neurons['OM4_2_E'], all_neurons['OM4_1'], 2.5, 18.05)
