...
class Topology:
	def __init__(self, simulation_params, test_iteration=0):
		...
		''' D1 '''
		# input from
		connect(C1, D1_1, delay=1.0, weight=30.0)
		connect(C1, D1_4, delay=1.0, weight=15.0)
		connect(C2, D1_1, delay=1.0, weight=30.0)
		connect(C2, D1_4, delay=1.0, weight=15.0)
		# inner connectomes
		connect(D1_1, D1_2, delay=2.0, weight=7.0)
		connect(D1_1, D1_3, delay=2.0, weight=10.0)
		connect(D1_2, D1_1, delay=2.0, weight=7.0)
		connect(D1_2, D1_3, delay=2.0, weight=10.0)
		connect(D1_3, D1_1, delay=2.0, weight=-50.0 * self.inh_coef)
		connect(D1_3, D1_2, delay=2.0, weight=-50.0 * self.inh_coef)
		connect(D1_4, D1_3, delay=2.0, weight=-50.0 * self.inh_coef)
		# output to
		connect(D1_3, G1_1, delay=1.0, weight=30.0)
		connect(D1_3, group1, delay=2.0, weight=5.0)

		connect(group1, D2_1, delay=2.0, weight=5.0)
		connect(group1, group2, delay=2.0, weight=29.0)

		''' D2 '''
		# input from
		connect(C2, D2_1, delay=1.0, weight=30.0)
		connect(C2, D2_4, delay=1.0, weight=15.0)
		connect(C3, D2_1, delay=1.0, weight=30.0)
		connect(C3, D2_4, delay=1.0, weight=15.0)
		# inner connectomes
		connect(D2_1, D2_2, delay=2.0, weight=7.0)
		connect(D2_1, D2_3, delay=2.0, weight=10.0)
		connect(D2_2, D2_1, delay=2.0, weight=7.0)
		connect(D2_2, D2_3, delay=2.0, weight=10.0)
		connect(D2_3, D2_1, delay=2.0, weight=-50.0 * self.inh_coef)
		connect(D2_3, D2_2, delay=2.0, weight=-50.0 * self.inh_coef)
		connect(D2_4, D2_3, delay=2.0, weight=-50.0 * self.inh_coef)
		# output to
		connect(D2_3, G2_1, delay=1.0, weight=30.0)

		''' D3 '''
		# input from
		connect(C3, D3_1, delay=1.0, weight=30.0)
		connect(C3, D3_4, delay=1.0, weight=15.0)
		connect(C4, D3_1, delay=1.0, weight=30.0)
		connect(C4, D3_4, delay=1.0, weight=15.0)

		connect(group2, D3_1, delay=2.0, weight=29.0)
		# inner connectomes
		connect(D3_1, D3_2, delay=2.0, weight=7.0)
		connect(D3_1, D3_3, delay=2.0, weight=10.0)
		connect(D3_2, D3_1, delay=2.0, weight=7.0)
		connect(D3_2, D3_3, delay=2.0, weight=10.0)
		connect(D3_3, D3_1, delay=2.0, weight=-50.0 * self.inh_coef)
		connect(D3_3, D3_2, delay=2.0, weight=-50.0 * self.inh_coef)
		connect(D3_4, D3_3, delay=2.0, weight=-50.0 * self.inh_coef)
		# output to
		connect(D3_3, G3_1, delay=3.0, weight=30.0)
		# suppression
		connect(D3_3, G1_3, delay=1.0, weight=30.0)

		connect(group2, group3, 2.0, 29.0)

		''' D4 '''
		# input from
		connect(C4, D4_1, delay=1.0, weight=30.0)
		connect(C4, D4_4, delay=1.0, weight=15.0)
		connect(C5, D4_1, delay=1.0, weight=30.0)
		connect(C5, D4_4, delay=1.0, weight=15.0)

		connect(group3, D4_1, 2.0, 29.0)
		# inner connectomes
		connect(D4_1, D4_2, delay=2.0, weight=7)
		connect(D4_1, D4_3, delay=2.0, weight=10.0)
		connect(D4_2, D4_1, delay=2.0, weight=7)
		connect(D4_2, D4_3, delay=2.0, weight=10.0)
		connect(D4_3, D4_1, delay=2.0, weight=-30.0 * self.inh_coef)
		connect(D4_3, D4_2, delay=2.0, weight=-30.0 * self.inh_coef)
		connect(D4_4, D4_3, delay=2.0, weight=-30.0 * self.inh_coef)
		# output to
		connect(D4_3, G4_1, delay=3.0, weight=20.0)
		# suppression
		connect(D4_3, G2_3, delay=1.0, weight=30.0)

		connect(group3, group4, 2.0, 29.0)

		''' D5 '''
		# input from
		connect(C5, D5_1, delay=1.0, weight=30.0)
		connect(C5, D5_4, delay=1.0, weight=15.0)
		connect(group4, D5_1, delay=2.0, weight=29.0)
		# inner connectomes
		connect(D5_1, D5_2, delay=2.0, weight=7.0)
		connect(D5_1, D5_3, delay=2.0, weight=10.0)
		connect(D5_2, D5_1, delay=2.0, weight=7.0)
		connect(D5_2, D5_3, delay=2.0, weight=10.0)
		connect(D5_3, D5_1, delay=2.0, weight=-50.0 * self.inh_coef)
		connect(D5_3, D5_2, delay=2.0, weight=-50.0 * self.inh_coef)
		connect(D5_4, D5_3, delay=2.0, weight=-50.0 * self.inh_coef)
		# output to
		connect(D5_3, G5_1, 4.0, 30.0)
		# suppression
		connect(D5_3, G4_3, 1.0, 30.0)
		connect(D5_3, G3_3, 1.0, 30.0)
		connect(D5_3, G2_3, 1.0, 30.0)
		connect(D5_3, G1_3, 1.0, 30.0)
		...
		connect(G1_3, G1_1, delay=1.0, weight=-30.0 * self.inh_coef)
		connect(G1_3, G1_2, delay=1.0, weight=-30.0 * self.inh_coef)
		# output to IP_E
		connect(G1_1, IP_E, delay=1.0, weight=35.0)
		connect(G1_2, IP_E, delay=1.0, weight=35.0)

		''' G2 '''
		# inner connectomes
		connect(G2_1, G2_2, delay=1.0, weight=7.0)
		connect(G2_1, G2_3, delay=1.0, weight=10.0)
		connect(G2_2, G2_1, delay=1.0, weight=7.0)
		connect(G2_2, G2_3, delay=1.0, weight=10.0)
		connect(G2_3, G2_1, delay=1.0, weight=-30.0 * self.inh_coef)
		connect(G2_3, G2_2, delay=1.0, weight=-30.0 * self.inh_coef)
		# output to IP_E
		connect(G2_1, IP_E, delay=1.0, weight=30.0)
		connect(G2_2, IP_E, delay=1.0, weight=30.0)
	...
	def connect_spike_generator(self, node, t_start, t_end, rate, offset=0.1):
		"""
		...
		# add spike times only in [t_start, t_end) interval
		spike_times = []
		...
		spike_generator = Create(
			...
			params={
				...
				'spike_weights': [500.] * len(spike_times)
			})
		# connect the spike generator with node
		Connect(pre=spike_generator,
		        post=node,
