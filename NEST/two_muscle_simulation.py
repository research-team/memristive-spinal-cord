...
class V3(Functions):
    ...
    def init_network(self):
        ...
        eIP_E_0 = self.form_group("eIP_E_0", int(neurons_in_ip / 7))
        eIP_E_1 = self.form_group("eIP_E_1", int(neurons_in_ip / 7))
        eIP_E_2 = self.form_group("eIP_E_2", int(neurons_in_ip / 7))
        eIP_E_3 = self.form_group("eIP_E_3", int(neurons_in_ip / 7))
        eIP_E_4 = self.form_group("eIP_E_4", int(neurons_in_ip / 7))
        eIP_E_5 = self.form_group("eIP_E_5", int(neurons_in_ip / 7))
        eIP_E_6 = self.form_group("eIP_E_6", int(neurons_in_ip / 7))
        ...
        def connect_to_ip(neuron, weight, delay):
            self.connect_fixed_outdegree(neuron, eIP_E_0, delay + 1.5, weight, int(neurons_in_ip / 7))
            self.connect_fixed_outdegree(eIP_E_0, eIP_E_1, 1.2, 8, int(neurons_in_ip / 9))

        # self.connect_fixed_outdegree(eIP_E_1, eIP_E_2, 0.5, 5, int(neurons_in_ip / 9))

        # self.connect_fixed_outdegree(eIP_E_2, eIP_E_3, 0.8, 10, int(neurons_in_ip / 7))
        # self.connect_fixed_outdegree(eIP_E_3, eIP_E_4, 0.8, 10, int(neurons_in_ip / 7))
        # self.connect_fixed_outdegree(eIP_E_4, eIP_E_5, 0.8, 12, int(neurons_in_ip / 7))
        # self.connect_fixed_outdegree(eIP_E_5, eIP_E_6, 0.8, 12, int(neurons_in_ip / 7))
        ...
        # self.connect_fixed_outdegree(eIP_E_3, MN_E, 3, weight, int(neurons_in_moto_extensor))
        # self.connect_fixed_outdegree(eIP_E_4, MN_E, 4, weight, int(neurons_in_moto_extensor))
        # self.connect_fixed_outdegree(eIP_E_5, MN_E, 3, weight, int(neurons_in_moto_extensor))
        ...
        self.connect_fixed_outdegree(E1, OM1_0, 3, 0.24)
        # input from sensory
        self.connect_one_to_all(CV1, OM1_0, 2.5, 0.12 * quadru_coef * sero_coef * toe_coef)
        self.connect_one_to_all(CV2, OM1_0, 2.5, 0.12 * quadru_coef * sero_coef * toe_coef)
        # [inhibition]
        ...
        # inner connectomes
        self.connect_fixed_outdegree(OM1_0, OM1_1, 1.5, 23)
        self.connect_fixed_outdegree(OM1_1, OM1_2_E, 2 * delay_coef, 5.5 * coef)
        self.connect_fixed_outdegree(OM1_1, OM1_2_F, 2.4, 8)
        self.connect_fixed_outdegree(OM1_1, OM1_3, 3, 1.6)
        self.connect_fixed_outdegree(OM1_2_E, OM1_1, 1.5 * delay_coef, 3.5 * coef)
        self.connect_fixed_outdegree(OM1_2_F, OM1_1, 2.5, 30)
        self.connect_fixed_outdegree(OM1_2_E, OM1_3, 1, 1.6)
        self.connect_fixed_outdegree(OM1_2_F, OM1_3, 0.4, 8)
        self.connect_fixed_outdegree(OM1_3, OM1_1, 1, -1 * inh_coef)
        self.connect_fixed_outdegree(OM1_3, OM1_2_E, 2.35, -0.42 * inh_coef)
        ...
        self.connect_fixed_outdegree(E2, OM2_0, 3, 0.15)
        # input from sensory [CV]
        self.connect_one_to_all(CV2, OM2_0, 2.5, 0.1 * quadru_coef * sero_coef * toe_coef)
        self.connect_one_to_all(CV3, OM2_0, 2.5, 0.1 * quadru_coef * sero_coef * toe_coef)
        # [inhibition]
        self.connect_one_to_all(CV4, OM2_3, 3, 80)
        self.connect_one_to_all(CV5, OM2_3, 3, 80)
        # # inner connectomes
        self.connect_fixed_outdegree(OM2_0, OM2_1, 1.5, 23)
        self.connect_fixed_outdegree(OM2_1, OM2_2_E, 2 * delay_coef, 5.5 * coef)
        self.connect_fixed_outdegree(OM2_1, OM2_2_F, 2.4, 8)
        self.connect_fixed_outdegree(OM2_1, OM2_3, 3, 1.6)
        self.connect_fixed_outdegree(OM2_2_E, OM2_1, 1.5 * delay_coef, 3.5 * coef)
        self.connect_fixed_outdegree(OM2_2_F, OM2_1, 2.5, 30)
        self.connect_fixed_outdegree(OM2_2_E, OM2_3, 1, 1.6)
        self.connect_fixed_outdegree(OM2_2_F, OM2_3, 0.4, 8)
        self.connect_fixed_outdegree(OM2_3, OM2_1, 1, -1 * inh_coef)
        self.connect_fixed_outdegree(OM2_3, OM2_2_E, 2.1, -0.42 * inh_coef)
        ...
        self.connect_fixed_outdegree(E3, OM3_0, 3, 0.14)
        # input from sensory [CV]
        self.connect_one_to_all(CV3, OM3_0, 2.5, 0.12 * quadru_coef * sero_coef * toe_coef)
        self.connect_one_to_all(CV4, OM3_0, 2.5, 0.12 * quadru_coef * sero_coef * toe_coef)
        # [inhibition]
        self.connect_one_to_all(CV5, OM3_3, 3, 80)
        # input from sensory [CD]
        self.connect_one_to_all(CD4, OM3_0, 3, 11)
        # inner connectomes
        self.connect_fixed_outdegree(OM3_0, OM3_1, 1.5, 23)
        self.connect_fixed_outdegree(OM3_1, OM3_2_E, 2 * delay_coef, 5.5 * coef)
        self.connect_fixed_outdegree(OM3_1, OM3_2_F, 2.4, 8)
        self.connect_fixed_outdegree(OM3_1, OM3_3, 3, 1.6)
        self.connect_fixed_outdegree(OM3_2_E, OM3_1, 1.5 * delay_coef, 3.5 * coef)
        self.connect_fixed_outdegree(OM3_2_F, OM3_1, 2.5, 30)
        self.connect_fixed_outdegree(OM3_2_E, OM3_3, 1, 1.6)
        self.connect_fixed_outdegree(OM3_2_F, OM3_3, 0.4, 8)
        self.connect_fixed_outdegree(OM3_3, OM3_1, 1, -1 * inh_coef)
        self.connect_fixed_outdegree(OM3_3, OM3_2_E, 2.1, -0.42 * inh_coef)
        ...
        self.connect_fixed_outdegree(E4, OM4_0, 3, 0.15)
        # input from sensory [CV]
        self.connect_one_to_all(CV4, OM4_0, 3.5, 0.12 * quadru_coef * sero_coef * air_coef)
        self.connect_one_to_all(CV5, OM4_0, 3.5, 0.12 * quadru_coef * sero_coef * air_coef)
        # input from sensory [CD]
        self.connect_one_to_all(CD4, OM4_0, 3, 11)
        self.connect_one_to_all(CD5, OM4_0, 3, 11)
        # inner connectomes
        self.connect_fixed_outdegree(OM4_0, OM4_1, 1.5, 24)
        self.connect_fixed_outdegree(OM4_1, OM4_2_E, 2 * delay_coef, 5.5 * coef)
        self.connect_fixed_outdegree(OM4_1, OM4_2_F, 2.4, 8)
        self.connect_fixed_outdegree(OM4_1, OM4_3, 3, 1.6)
        self.connect_fixed_outdegree(OM4_2_E, OM4_1, 1.5 * delay_coef, 3.5 * coef)
        self.connect_fixed_outdegree(OM4_2_F, OM4_1, 2.5, 30)
        self.connect_fixed_outdegree(OM4_2_E, OM4_3, 1, 1.6)
        self.connect_fixed_outdegree(OM4_2_F, OM4_3, 0.4, 8)
        self.connect_fixed_outdegree(OM4_3, OM4_1, 1, -1 * inh_coef)
        self.connect_fixed_outdegree(OM4_3, OM4_2_E, 2.1, -0.42 * inh_coef)
        ...
        self.connect_fixed_outdegree(E5, OM5_0, 3.5, 0.13)
        # input from sensory [CV]
        self.connect_one_to_all(CV5, OM5_0, 3, 0.107 * quadru_coef * sero_coef * air_coef)
        # input from sensory [CD]
        self.connect_one_to_all(CD5, OM5_0, 3, 11)
        # inner connectomes
        self.connect_fixed_outdegree(OM5_0, OM5_1, 1.5, 24)
        self.connect_fixed_outdegree(OM5_1, OM5_2_E, 2 * delay_coef, 5.5 * coef)
        self.connect_fixed_outdegree(OM5_1, OM5_2_F, 2.4, 8)
        self.connect_fixed_outdegree(OM5_1, OM5_3, 3, 1.6)
        self.connect_fixed_outdegree(OM5_2_E, OM5_1, 1.5 * delay_coef, 3.5 * coef)
        self.connect_fixed_outdegree(OM5_2_F, OM5_1, 2.5, 30)
        self.connect_fixed_outdegree(OM5_2_E, OM5_3, 1, 1.6)
        self.connect_fixed_outdegree(OM5_2_F, OM5_3, 0.4, 8)
        self.connect_fixed_outdegree(OM5_3, OM5_1, 1, -1 * inh_coef)
        self.connect_fixed_outdegree(OM5_3, OM5_2_E, 2.35, -0.42 * inh_coef)
