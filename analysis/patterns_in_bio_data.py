...
def bio_data_runs():
	data.append([-d for d in mat_data[0][:1200]])
	data.append([-d for d in mat_data2[0][:1200]])
	data.append([-d for d in mat_data3[0][:1200]])
	data.append([-d for d in mat_data4[0][:1200]])
	data.append([-d for d in mat_data5[0][1400:2600]])
