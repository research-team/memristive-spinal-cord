...
layer1_neuron_group_params[Layer1NeuronGroupNames.FLEX_RENSHAW] = NeuronGroupParams(
    type=NEST_NAMESPACE.GABA,
    model=general_neuron_model,
    number=neuron_number_in_group,
)

layer1_neuron_group_params[Layer1NeuronGroupNames.EXTENS_RENSHAW] = NeuronGroupParams(
    type=NEST_NAMESPACE.GABA,
    model=general_neuron_model,
    number=neuron_number_in_group,
)
...
layer1_neuron_group_params[Layer1NeuronGroupNames.FLEX_INTER_1B] = NeuronGroupParams(
    type=NEST_NAMESPACE.GABA,
    model=general_neuron_model,
    number=neuron_number_in_group,
)

layer1_neuron_group_params[Layer1NeuronGroupNames.EXTENS_INTER_1B] = NeuronGroupParams(
    type=NEST_NAMESPACE.GABA,
    model=general_neuron_model,
    number=neuron_number_in_group,
)
