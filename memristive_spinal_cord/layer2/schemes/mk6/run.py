...
import os
from memristive_spinal_cord.layer2.schemes.mk6.toolkit import Plotter
from memristive_spinal_cord.layer2.schemes.mk6.components.parameters import Paths
from memristive_spinal_cord.layer2.schemes.mk6.components.parameters import Constants
...
from memristive_spinal_cord.layer2.schemes.mk6.layer2 import Layer2
layer2 = Layer2()

api_kernel.Simulate(Constants.SIMULATION_TIME.value)

toolkit.plot_tier(1, 2, 3, 4, 5, 6)
toolkit.plot_interneuronal_pool(show_results=False, split=True, period=25.)
