...
class HiddenTier:
    ...
    def set_connections(self):
        # left excitatory to right excitatory
        ...
        # right excitatory to left excitatory
    ...
    def get_left_excitatory(self): return self.right_excitatory

    def get_left_inhibitory(self): return self.right_inhibitory
    ...
    def connect(self, upper_tier:Tier, lower_tier:Tier):
        ...
        upper_tier.get_control_group().nuclei(Neurotransmitters.GLU.value).connect(
            ...
            synapse=Synapses.GLUTAMATERGIC.value,
            weight=HiddenWeights.UCID.value[::-1][self.get_index()-1],
            conn_type=ConnectionTypes.ONE_TO_ONE.value
        )
