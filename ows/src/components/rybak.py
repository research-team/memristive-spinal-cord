...
class Rybak:
    ...
    def set_connections(self):
        ...
        connect(pre=self.s1.gids, post=self.pool_flexor.gids, weight=-100)
        connect(pre=self.s0.gids, post=self.pool_extensor.gids, weight=-100)
        ...
        connect(pre=self.pool_extensor.gids, post=self.pool_flexor.gids, weight=-100)
        connect(pre=self.pool_extensor.gids, post=self.moto_extensor.gids, weight=250)
        ...
        connect(pre=self.aff_ia_extensor.gids, post=self.moto_extensor.gids, weight=250)
